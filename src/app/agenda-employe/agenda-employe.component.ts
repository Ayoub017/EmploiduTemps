...
@Component({
  selector: 'app-agenda-employe',
  templateUrl: './agenda-employe.component.html',
  styleUrls: ['./agenda-employe.component.css']
})
export class AgendaEmployeComponent implements AfterViewInit {
  ...
  generateAppointments(): any {
    ...
    const appointment1 = {
      id: 'id1',
      location: '',
      subject: 'Travail présenciel',
      calendar: 'Travail sur site',
    ...
    const appointment6 = {
      ...
      location: '',
      subject: 'Travail ',
      calendar: 'Travail à l\'éxtérieur',
